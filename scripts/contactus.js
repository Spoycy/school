...
` +
  ...
  var Et = dt((Be, ie) => {
    ...
    Q.ready = function () {
      (It = !0), Ht ? We() : pt.each(At, Yt), pt.each(Bt, Yt), Q.resize.up();
    };
    function Yt(e) {
      yt(e) && e();
    }
      ...
      (ve.exports = function (e, x) {
        ...
        function W(z) {
          ...
          if (((k.href = L), !(L.indexOf(":") >= 0))) {
            ...
            if (!(L === "#" || L === "")) {
              var w = k.href === C.href || L === V || (G.test(L) && Z.test(V));
              B(v, $, w);
            }
          }
        }
      ...
      (ge.exports = function (e) {
        ...
        function O(_) {
          ...
          function U(B) {
            ...
            (z && z.length > 1) ||
              ((C = !0),
              z ? ((k = !0), (G = z[0].clientX)) : (G = B.clientX),
              (Z = G));
          }
          function V(B) {
            if (C) {
...
function sendMail () {
  let parms = {
    ...
    subject: document.getElementById("email-2").value,
    message: document.getElementById("email-3").value,
    email: document.getElementById("name").value
  }
  
  emailjs.send("service_i84mei7","template_vcserzl",parms);
}